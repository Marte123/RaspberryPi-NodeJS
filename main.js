...
var connection = io( 'http://192.168.0.38:9000' );
...
var emitEvent = function( event ) {
  ...
  if( event.target.id === 'button-yellow') { button_yellow_state = ! button_yellow_state; }
  ...
  connection.emit( 'led-toggle', {
    r: button_red_state,
    g: button_yellow_state,
    b: button_green_state,
  } );
};
